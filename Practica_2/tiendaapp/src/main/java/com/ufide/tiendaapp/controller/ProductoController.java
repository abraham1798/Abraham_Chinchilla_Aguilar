...
/** GET /productos - listar todos o buscar por nombre/categoria */
    ...
    public String listar(Model modelo,
        ...
        if (buscar != null && !buscar.isBlank()) {
            ...
            // Ajustado para que use tu método exacto del Service:
    ...
    // ==========================================
    // === PASO 4.1: UPDATE (Editar / Actualizar) ===
    // ==========================================
    ...
    public String actualizar(@PathVariable Long id,
        ...
        producto.setId(id); // Forzar que modifique el ID existente y no genere un duplicado
        productoService.guardar(producto);
